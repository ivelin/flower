...
from smolvla_example.task import get_dataset, get_model, get_params, set_params
...
def get_evaluate_fn_callback(save_path: Path):
    ...
    def evaluate_fn(server_round: int, parameters, config):
        ...
        if server_round % 5 == 0:
            # Instantiate model
            dataset = get_dataset("pick_place")
...
def server_fn(context: Context) -> ServerAppComponents:
    ...
    # Set global model initialization using pick_place as default
    dataset = get_dataset("pick_place")
